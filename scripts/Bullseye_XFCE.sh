...
sudo apt install -y  task-xfce-desktop firefox-esr bleachbit mpd ncmpcpp geany synaptic doublecmd-common terminator rxvt-unicode simplescreenrecorder gdebi mpv package-update-indicator firmware-linux firmware-linux-nonfree firmware-misc-nonfree  mousepad ristretto  psmisc flameshot diodon fonts-firacode lightdm lightdm-gtk-greeter network-manager-gnome package-update-indicator plymouth-themes qt5-style-plugins wmctrl xdotool htop xfce4-xkb-plugin numlockx curl bsdmainutils
